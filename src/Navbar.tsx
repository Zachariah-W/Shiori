...
const Navbar = () => (
  <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/80 py-3 backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/90">
    <nav className="w-layout flex items-center justify-between">
      <Link
        to="/Home"
